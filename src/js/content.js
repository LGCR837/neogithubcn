const allData = [
  ...
  [`No milestone`, `无进程`],
  [`Development`, `发展`],
  [`Shows branches and pull requests linked to this issue.`, `显示链接到此问题的分支和拉取请求。`],
  [`Helpful resources`, `可利用的资源`],
  [`GitHub Community Guidelines`, `GitHub 社区规则`],
  [`Jump to`, `跳转`],
  [`Give feedback`, `意见反馈`],
  ...
  [`Add a .gitignore`, `添加一个 .gitignore 文件`],
  [`Add a license`, `添加一个许可证`],
  [`Help people interested in this repository understand your project by adding a README.`,`通过添加自述文件来帮助对此存储库感兴趣的人去了解您的项目。`],
  [`license`,`许可证`],
  [`Contact`,`联系`],
  [`No releases published`,`没有发布任何版本`],
  [`Manage cookies`,`管理 Cookie`],
  [`Do not share my personal information`,`隐私`],
  [`Home`,`主页`],
  [`Create new...`,`创建`],
  ...
  [`last year`,`去年`],
  [`last 5 years`,`过去 5 年`],
  [`last 10 years`,`过去 10 年`],
  [`last 20 years`,`过去 20 年`],
  [`Open issues in `,`打开的问题`],
  [`Open pull requests in `,`打开的合并请求`],
  [`Open discussions in `,`打开的讨论`],
  [`Open issues in `,`打开的问题`],
  [`Open pull requests in `,`打开的合并请求`],
  [`Open discussions in `,`打开的讨论`],
  [`Open issues in `,`打开的问题`],
  ...
  [`Create a site or blog from your GitHub repositories with GitHub Pages.`,`从 GitHub 仓库创建一个网站或博客。`],
  [`Get started using GitHub in less than an hour.`,`快速开始使用 GitHub。`],
  [`Learn more`,`了解更多`],
  [`Develop with AI-powered code suggestions using GitHub Copilot, Codespaces, and VS Code.`,`使用 AI 编写，并通过 GitHub Copilot、Codespaces 和 VS Code 进行开发。`],
  [`Create a GitHub Action and use it in a workflow.`,`创建一个 GitHub 活动并将其用于自动化工作流。`],
  [`Introduction to GitHub`,`GitHub 介绍`],
  [`Code with Copilot`,`使用 Copilot 编写代码`],
  [`Hello GitHub Actions`,`你好 Github 活动`],
  [`See more tutorial projects`,`查看更多教程项目`],
  [`Start writing code`,`开始编写代码`],
  [`Start a new repository for`,`开始使用一个新的储存库在`],
  [`A repository contains all of your project's files, revision history, and collaborator discussion.`,`一个仓库可以包含所有项目的文件、修订历史和协作讨论。`],
  [`name your new repository...`,`储存库名称`],
  [`Anyone on the internet can see this repository`,`任何人都可以查看这个储存库`],
  [`You choose who can see and commit to this repository`,`你可以选择指定的人查看和修改这个储存库`],
  [`Repositories that need your help`,`需要你帮助的储存库`],
  [`See more repos with good first issues`,`查看更多带有问题的储存库`],
  [`Use tools of the trade`,`使用工具`],
  [`Simplify your development workflow with a GUI`,`通过 GUI 简化你的开发过程`],
  [`Install GitHub Desktop`,`安装 GitHub Desktop`],
  [`to visualize, commit, and push changes without ever touching the command line.`,`可视化、提交和推送更改，而无需使用命令行。`],
  [`Get AI-based coding suggestions`,`使用 AI 编写代码`],
  [`Follow this exercise to try the GitHub flow`,`按照此练习尝试 GitHub 流程`],
  [`GitHub's “Hello World” tutorial teaches you essentials, where you create your own repository and learn GitHub's pull request workflow for creating and reviewing code.`,`GitHub 的“Hello World”教程教您基本知识，您可以在其中创建自己的存储库并学习 GitHub 的拉取请求工作流程，以创建和审查代码。`],
  [`You have unread notifications`,`您有未读通知`],
  [`All`,`全部`],
  [`Unread`,`未读`],
  [`Select all`,`全选`],
  [`Watched repositories`,`受监视的存储库`],
  [``,``],
  [``,``],
  [``,``],
  [``,``],
